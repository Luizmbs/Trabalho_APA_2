...
def executar_analise_fecho_transitivo(arestas, vertices, vertice_inicial):
    ...
    return {
        'basico': {'fecho': fecho_basico, 'tempo': tempo_basico},
        'otimizado': {'fecho': fecho_otimizado, 'tempo': tempo_otimizado}
    }
